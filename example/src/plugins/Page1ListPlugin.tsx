/*
 * Created Date: 2019-12-19 13:59:53
 * Author: docoder at <docoder@163.com>
 * Last Modified: 2019-12-19 13:59:53
 * Modified By: docoder at <docoder@163.com>
 * Copyright (c) 2019 docoder.com
 * HISTORY:
 */
    ...
    apply(hooks: AppHooks) {
        hooks.beforeTableColumnFinalization.tap(
            ...
            (appKey: string, pageKey: string, tableKey: string, props: any, column: TableColumn) => {
                if (appKey !== 'Test-Entry' || pageKey !== 'test-entry-page1' || tableKey !== 'sub1Table') return;
        ...
        hooks.afterPageLoaded.tap(
            ...
            (appKey: string, pageKey: string, pageJson: any) => {
                if (appKey !== 'Test-Entry' || pageKey !== 'test-entry-page1') return;
            },
        );
